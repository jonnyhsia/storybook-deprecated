...
class StateBottomSheet : BottomSheetDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        // 创建 dialog 的内容布局
        val view = View.inflate(context, R.layout.dialoh_sheet_states, null)
     ...
     */
    fun setSheetAction(action: () -> Unit) {
        sheetAction = action
    }
    ...
    companion object {
        ...
        private val EXTRA_ACTION = "action"
        ...
        fun generateStateSheet(state: State): StateBottomSheet {
            ...
            sheet.arguments = Bundle().apply {
                ...
                putInt(EXTRA_ACTION, state.action)
            }
            return sheet
        }
    }
